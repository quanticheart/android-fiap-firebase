...
package com.quanticheart.core.notification
...
import com.quanticheart.core.notification.ResourcesHelper.getStringResourceByKey
...
class Notify(private val context: Context) {
    ...
    fun setMessage(content: CharSequence): Notify {
